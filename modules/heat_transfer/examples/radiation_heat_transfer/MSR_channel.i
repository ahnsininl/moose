...
## refraction index and coefficients of radiation ##
n1 = 1.20
n2 = 1.00

alpha = 0.955719733765
...
## absorptivities along frequency ##
nu_min = 1e-2
nu1 = 2.93e13
nu2 = 3.42e13
nu3 = 3.73e13
...
[Problem]
  nl_sys_names = 'u_system v_system pressure_system TKE_system TKED_system
                  t psi11 psi12 psi13 psi21 psi22 psi23'
...
[FVKernels]
  ...
  [energy_source]
    ...
    variable = T
    absorptivities = '${kappa1to2} ${kappa2to3} ${kappa3tomax}'
